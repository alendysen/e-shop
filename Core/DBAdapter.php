...
namespace Core;
/**
* Modified from github.com/rorystandley/MySQL-CRUD-PHP-OOP
* MySQL
*/
class DBAdapter
{
	 ...
	 * Database class
	 */
	protected $db_host;  // Change as required
	protected $db_user;  // Change as required
	protected $db_pass;  // Change as required
	protected $db_name;  // Change as required
	...
	public function select($rows = '*', $join = null, $where = null, $order = null, $limit = null){
			// Create query from the variables passed to the function
		$q = 'SELECT '.$rows.' FROM '.$this->table;
		if($join != null){
			$q .= ' JOIN '.$join;
		}
		if($where != null){
	...
	//Function to delete table or row(s) from database
		public function delete($where = null){
			...
			if($where == null){
				$delete = 'DELETE '.$this->table; // Create query to delete table
			}else{
				$delete = 'DELETE FROM '.$this->table.' WHERE '.$where; // Create query to delete rows
			}
	...
	// Function to update row in database
		public function update($params=array(),$where){
			...
			// Create the query
			$sql='UPDATE '.$this->table.' SET '.implode(',',$args).' WHERE '.$where;
